...
class ProductAttributeValue(models.Model):
    ...
    def name_search(self, name="", domain=None, operator="ilike", limit=100):
        ...
        """
        # 19.0: name_search's second positional argument was renamed
        # `args` -> `domain` on BaseModel; signature + internal refs updated
        # to match (verified in odoo/orm/models.py).
        ...
        if product_tmpl_id:
            ...
            new_domain.append(("id", "in", val_ids))
            ...
            if attr_restrict_ids:
                new_domain.append(("attribute_id", "not in", attr_restrict_ids))
            domain = new_domain
