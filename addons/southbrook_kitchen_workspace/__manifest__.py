...
""",
    ...
    "data": [
        ...
        "data/kitchen_appliance_catalog.xml",
        ...
        "views/product_template_appliance_views.xml",
        "views/southbrook_kitchen_workspace_menus.xml",
    ],
    "assets": {
        "web.assets_backend": [
            "southbrook_kitchen_workspace/static/src/scss/kitchen_workspace_form_scroll.scss",
        ],
    },
    "installable": True,
    "application": False,
